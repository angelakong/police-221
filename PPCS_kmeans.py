...
if runMultVarKMeans:
  ...
  # 9: [SRWI, Reason for stop, Officer race] vs. Police Behave Properly (v347)
  vars_9 = pandas.concat([sex, race, work, income, v34, v39, v41, v43, v45, v47, v49, v51, v67, v68, v69, v71, v73], axis=1)
  X_train9, X_test9, y_train9, y_test9 = train_test_split(vars_9, v347, random_state=0)
  makeNumClustersPlot(X_train9, plt, fig2, 428, 'SRWI/Reason for stop/Officer race')
  [kmeans9, label_freq9] = runKMeans3(4, X_train9, 'SRWI/Reason for stop/Officer race')
  v347_yes_counts_9 = [0] * len(label_freq9)
  for label in kmeans9.labels_:
    v347_yes_counts_9[label] += y_train9.iloc[label]['Yes']
  for label_freq_i in range(len(v347_yes_counts_9)):
    v347_yes_counts_9[label_freq_i] = 1.0*v347_yes_counts_9[label_freq_i]/(1.0 * label_freq9[label_freq_i])
  testKMeans(kmeans9, X_test9, y_test9, v347_yes_counts_9)
...
if runRandomForest:
  ...
  rf_predicted5 = rf_classifier5.predict(X_test5)
  print (classification_report(y_test5, rf_predicted5))
  ...
  rf_predicted6 = rf_classifier6.predict(X_test6)
  print (classification_report(y_test6, rf_predicted6))
  ...
  rf_predicted7 = rf_classifier7.predict(X_test7)
  print (classification_report(y_test7, rf_predicted7))
  ...
  rf_predicted8 = rf_classifier8.predict(X_test8)
  print (classification_report(y_test8, rf_predicted8))

  # RF 9: [SRWI, Reason for stop, Officer Race] vs. Police Behave Properly (v347)
  rf_classifier9 = RandomForestClassifier(n_estimators=5)
  rf_classifier9 = rf_classifier9.fit(X_train9, y_train9)
  rf_accuracy9 = rf_classifier9.score(X_test9, y_test9)
  print "Random Forest (SRWI, Reason for stop, Officer Race) accuracy:", rf_accuracy9
  rf_predicted9 = rf_classifier9.predict(X_test9)
  print (classification_report(y_test9, rf_predicted9))
